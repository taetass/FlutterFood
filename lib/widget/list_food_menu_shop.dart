...
import 'package:flutter_appfood/model/food_model.dart';
import 'package:flutter_appfood/screens/add_food_menu.dart';
import 'package:flutter_appfood/screens/edit_food_menu.dart';
...
class _ListFoodMenuShopState extends State<ListFoodMenuShop> {
  ...
  Future<Null> readFoodMenu() async {
    ...
    String url =
        'http://localhost/FlutterFood/getFoodWhereId.php?isAdd=true&idShop=$idShop';
        ...
        itemBuilder: (context, index) => Row(
          children: <Widget>[
            Container(
              ...
              child: Image.network(
                'http://localhost/${foodModels[index].pathImage}',
                fit: BoxFit.cover,
              ),
            ),
            Container(
            ...
            children: <Widget>[
              FlatButton(
                onPressed: () async {
                  ...
                  String url =
                      'http://localhost/FlutterFood/deleteFoodWhereId.php?isAdd=true&id=${foodModel.id}';
